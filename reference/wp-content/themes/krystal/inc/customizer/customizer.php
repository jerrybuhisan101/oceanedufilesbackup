...
function krystal_customize_register( $wp_customize ) {
    ...
    // Documentation 
    $wp_customize->add_section(
        'krystal_doc_settings',
        array(
            'priority'      => 200,
            'capability'    => 'edit_theme_options',
            'theme_supports'=> '',
            'title'         => __( 'krystal Documentation', 'krystal' ),
            'description' => '<p class="customize-control-title">' .__('Check Complete documention of this theme','krystal'). '</p><h3>' .'<a target="_blank" href="https://www.spiraclethemes.com/krystal-documentation/">'. __('View Documentation','krystal'). '</a></h3>',         
        )
    );    
    ...
    $wp_customize->add_control(
        new krystal_Documentation(
            $wp_customize,
            'kr_doc_text',
            array(
                'settings'      => 'kr_doc_text',
                'section'       => 'krystal_doc_settings',                            
            )
        )
    );
    ...
    // Buy Now //
    $wp_customize->add_section(
        'krystal_buy_settings',
        array(
            'priority'      => 10,
            'capability'    => 'edit_theme_options',
            'theme_supports'=> '',
            'title'         => __( 'Buy Pro Version', 'krystal' ),
            'description' => '<p class="customize-control-title">' .__('Buy Pro version of this theme for extra features and dedicated support','krystal'). '</p><h3>' .'<a target="_blank" href="https://www.spiraclethemes.com/krystal-premium-wordpress-theme/">'. __('Buy Pro Version','krystal'). '</a></h3>',         
        )
    );    
    ...
    $wp_customize->add_control(
        new Krystal_Documentation(
            ...
            'kr_buy_text',
            array(
                'settings'      => 'kr_buy_text',
                'section'       => 'krystal_buy_settings',                            
            )
        )
    );
